...
python3 $TAPES annotate -i ${INPUT_DIR}/bcftools_gatk_vcftools50_norm.vcf.gz  -o ${OUTPUT_DIR}/annotated50.vcf --acmg -a hg38
python3 $TAPES sort -i ${OUTPUT_DIR}/annotated50.hg38_multianno.vcf -o ${OUTPUT_DIR}/acmg_results50/ --tab -t 4 -a hg38
