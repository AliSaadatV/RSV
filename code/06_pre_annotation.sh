...
tabix -p vcf bcftools_gatk_vcftools50.vcf.gz

# Normalize and break multiallelic 
$VT decompose -s -o temp.vcf bcftools_gatk_vcftools50.vcf.gz
$VT normalize -r $REF -o bcftools_gatk_vcftools50_norm.vcf temp.vcf
bgzip -@ 20 -c bcftools_gatk_vcftools50_norm.vcf > bcftools_gatk_vcftools50_norm.vcf.gz
tabix -p vcf bcftools_gatk_vcftools50_norm.vcf.gz
rm temp.vcf
